...
func NewMessageQueue(filterConfigRootPath string, posixQueueMountPath stringhttps://github.com/feyeleanor/raw/blob/master/byte_slice.go) (*MessageQueue, error) {
// change: don't need
